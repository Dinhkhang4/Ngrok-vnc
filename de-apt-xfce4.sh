...
apk add --no-cache ca-certificates curl openssl xvfb x11vnc xfce4 xfce4-terminal faenza-icon-theme dbus-x11 bash xfce4-whiskermenu-plugin
apk add neofetch tango-icon-theme
